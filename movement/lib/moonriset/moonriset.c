...
double
interpolate(double f0, double f1, double f2, double p) {
    double a = f1 - f0;
    double b = f2 - f1 - a;
...
double
localSiderealTime(double offsetDays, double longitude) {
